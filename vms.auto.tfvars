vms = {
  ...
  incus-01       = { pvi = "ubuntu-24", vcpus = 2, memory = 8129, disk_size = 15, extra_networks = ["cluster"] },
  incus-02       = { pvi = "ubuntu-24", vcpus = 2, memory = 8129, disk_size = 15, extra_networks = ["cluster"] },
  checkmk        = { pvi = "rocky-9", description = "Checkmk monitoring platform", vcpus = 2, memory = 4096, disk_size = 20 },
  grafana        = { pvi = "almalinux-10", description = "Grafana monitoring platform", vcpus = 2, memory = 4096, disk_size = 20 },
  docker-01      = { pvi = "rocky-10", description = "Docker server (w/GPU passthrough)", vcpus = 1, memory = 2048, gpu_passthrough = true },
}
